const sampleListings = [
  {
    ...
    owner: "68c82db9507ded15b22f26cb",
    category: "mountains"
  },
  {
  ...
  // Add remaining listings in the same pattern with owner and random category
];


// let final = sampleListings.map(list => ({ title: list.title, description: list.description, image: list.image, price: list.price, country: list.country, location: list.location }))
